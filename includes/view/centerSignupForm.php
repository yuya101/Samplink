			...
			<div class="col-md-9 col-md-offset-1" style="padding-top:30px;padding-bottom:30px;">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="includes/control/loginUser_Ctl.php" method="post" role="form" style="display: none;">
								...
								<form id="register-form" action="includes/control/signupMember_Ctl.php" method="post" role="form" style="display: block;">
									<div class="form-group">
