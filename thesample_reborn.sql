...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2016 at 04:31 PM
...
CREATE TABLE IF NOT EXISTS `admin` (
  `aid` int(5) NOT NULL,
  `ausername` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `apass` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `aname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `alastname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `afirstname` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `groupid` tinyint(2) NOT NULL,
  `email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `adddate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addtime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `moddate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modtime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addip` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `modip` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `addaid` smallint(3) NOT NULL,
  `modaid` smallint(3) NOT NULL
...
INSERT INTO `admin` (`aid`, `ausername`, `apass`, `aname`, `alastname`, `afirstname`, `groupid`, `email`, `adddate`, `addtime`, `moddate`, `modtime`, `addip`, `modip`, `addaid`, `modaid`) VALUES
(1, 'ADMINISTRATOR', 'MTIzNA==', 'Administrator', 'Root', 'นาย', 1, 'admin@hrm.co.th', '20121212', '10:00:00', '20151021', '23:58:55', '128.0.0.1', '::1', 1, 1),
(2, 'YUYA101@GMAIL.COM', 'MTEx', 'Sawat', 'Vinitphol', '-', 1, 'yuya101@gmail.com', '20160416', '19:59:13', '20160416', '19:59:13', '::1', '::1', 1, 1),
(3, 'YUYA@GMAIL.COM', 'MTExMQ==', 'Test', 'Test2', '-', 1, 'yuya@gmail.com', '20160422', '00:11:29', '20160422', '00:11:29', '::1', '::1', 1, 1);
...
CREATE TABLE IF NOT EXISTS `admin_auth` (
  `aid` smallint(3) NOT NULL,
  `topicid` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลสิทธิ์การเข้าถึง';
...
CREATE TABLE IF NOT EXISTS `admin_detail` (
  ...
  `dateOfBirth` varchar(8) COLLATE utf16_unicode_ci NOT NULL,
  `address` text COLLATE utf16_unicode_ci NOT NULL,
  `contactNo1` varchar(100) COLLATE utf16_unicode_ci NOT NULL,
  `contactNo2` varchar(100) COLLATE utf16_unicode_ci NOT NULL,
  `photograph` varchar(255) COLLATE utf16_unicode_ci NOT NULL,
  `email` varchar(100) COLLATE utf16_unicode_ci NOT NULL,
  `upassword` varchar(20) COLLATE utf16_unicode_ci NOT NULL,
  `appointmentDate` varchar(8) COLLATE utf16_unicode_ci NOT NULL,
  `joiningDate` varchar(8) COLLATE utf16_unicode_ci NOT NULL,
  `empcode` varchar(50) COLLATE utf16_unicode_ci NOT NULL,
  `department` int(5) NOT NULL,
  `empsalary` int(11) NOT NULL,
  `qualification1` varchar(255) COLLATE utf16_unicode_ci NOT NULL,
  `qualification2` varchar(255) COLLATE utf16_unicode_ci NOT NULL,
  `qualification3` varchar(255) COLLATE utf16_unicode_ci NOT NULL,
  `qualification4` varchar(255) COLLATE utf16_unicode_ci NOT NULL,
  `qualification5` varchar(255) COLLATE utf16_unicode_ci NOT NULL,
  `addressproof` varchar(300) COLLATE utf16_unicode_ci NOT NULL,
  `idproof` varchar(300) COLLATE utf16_unicode_ci NOT NULL,
  `bankaccountname` varchar(100) COLLATE utf16_unicode_ci NOT NULL,
  `bankaccountnumber` varchar(15) COLLATE utf16_unicode_ci NOT NULL,
  `bankbranch` varchar(100) COLLATE utf16_unicode_ci NOT NULL,
  `bankifsc` varchar(100) COLLATE utf16_unicode_ci NOT NULL,
  `bankcity` varchar(100) COLLATE utf16_unicode_ci NOT NULL,
  `remarks` text COLLATE utf16_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf16 COLLATE=utf16_unicode_ci COMMENT='Employee Detail';

--
-- Dumping data for table `admin_detail`
--

INSERT INTO `admin_detail` (`aid`, `firstname`, `lastname`, `dateOfBirth`, `address`, `contactNo1`, `contactNo2`, `photograph`, `email`, `upassword`, `appointmentDate`, `joiningDate`, `empcode`, `department`, `empsalary`, `qualification1`, `qualification2`, `qualification3`, `qualification4`, `qualification5`, `addressproof`, `idproof`, `bankaccountname`, `bankaccountnumber`, `bankbranch`, `bankifsc`, `bankcity`, `remarks`) VALUES
(2, 'Sawat', 'Vinitphol', '20160804', '3-5-7 Watchirawutdumnoun Rd. Muang', '+66846999982', '+66846999982', 'photograph20160416195913.jpg', 'yuya101@gmail.com', 'MTEx', '20160704', '20160204', '52000', 1, 50000, 'qualification120160416195913.jpg', '-', '-', '-', 'qualification520160416195913.jpg', '-', 'idproof20160416195913.jpg', 'Sawat Vinitphol', '3131321', '3132132132', '31321321', '3213', '1321321'),
(3, 'Test', 'Test2', '20161404', 'ewrewrwe', 'rwerwe', 'rwerwerwe', '-', 'yuya@gmail.com', 'MTExMQ==', '20160704', '20162604', 'EETERE', 2, 5000, '-', '-', '-', '-', '-', '-', '-', 'erwerwer', 'rwerwe', 'gdfgdfg', 'ghfghfg', 'hfghfghfg', 'fghfghfg');
...
CREATE TABLE IF NOT EXISTS `admin_history` (
  `aid` smallint(3) NOT NULL,
  `login_date` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `login_time` varchar(8) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `blog_answer` (
  ...
  `answerName` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `answerEmail` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `answerWebsite` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `answerComment` text COLLATE utf8_unicode_ci NOT NULL,
  `answerIP` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `blog_answer` (`answerID`, `blogID`, `answerName`, `answerEmail`, `answerWebsite`, `answerComment`, `answerIP`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(1, 1, 'สวัสดิ์ วินิจผล', 'yuya101@gmail.com', 'http://www.pnsport.com', 'ทดสอบการ Add Reply', '127.0.0.1', '20130829', '14:16:24', 1, '20130829', '14:16:24', 1);
...
CREATE TABLE IF NOT EXISTS `blog_detail` (
  ...
  `blogDetail` text COLLATE utf8_unicode_ci NOT NULL,
  `blogStartDateShow` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `blogPicture1` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `blogPicture2` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `blogPicture3` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `blogAnswerCount` int(5) NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` varchar(3) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `blog_detail` (`blogID`, `blogTitle`, `blogDetail`, `blogStartDateShow`, `blogPicture1`, `blogPicture2`, `blogPicture3`, `blogAnswerCount`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(1, 'ทดสอบ Add ข้อมูลลง Blog', 'ทดสอบเพิ่มเนื้อหา Blog', '20130825', 'blogPicture020130826230306.jpg', '-', 'blogPicture220130826230306.png', 0, '20130825', '22:40:22', 1, '20130825', '22:40:22', '1');
...
CREATE TABLE IF NOT EXISTS `member_detail` (
  ...
  `bname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `blastname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `bsex` int(1) NOT NULL,
  `gcID` varchar(13) COLLATE utf8_unicode_ci NOT NULL COMMENT 'GREEN CARD ID',
  `taxID` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `travelID` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `dateOfBirth` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `nationality` int(1) NOT NULL,
  `marriedStatus` int(1) NOT NULL,
  `gcaddress` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `gcvillage` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `gcsoi` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `gcroad` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `gctumbon` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `gcamphor` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `gcprovince` int(2) NOT NULL,
  `gcpostcode` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `psaddress` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `psvillage` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `pssoi` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `psroad` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pstumbon` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `psamphor` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `psprovince` int(2) NOT NULL,
  `pspostcode` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `btelephone` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `btelephoneext` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `bfax` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `bfaxext` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `bmobile` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `bemail` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `registerDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `registerTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `lastmodDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `lastmodTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `lastmodID` int(8) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `member_detail` (`memberID`, `bname`, `blastname`, `bsex`, `gcID`, `taxID`, `travelID`, `dateOfBirth`, `nationality`, `marriedStatus`, `gcaddress`, `gcvillage`, `gcsoi`, `gcroad`, `gctumbon`, `gcamphor`, `gcprovince`, `gcpostcode`, `psaddress`, `psvillage`, `pssoi`, `psroad`, `pstumbon`, `psamphor`, `psprovince`, `pspostcode`, `btelephone`, `btelephoneext`, `bfax`, `bfaxext`, `bmobile`, `bemail`, `registerDate`, `registerTime`, `lastmodDate`, `lastmodTime`, `lastmodID`) VALUES
(1, 'สวัสดิ์', 'วินิจผล', 1, '-', '-', '-', '19791023', 0, 1, '3-5-7-7/1', '-', '-', 'วชิราวูธดำเนิน', '5415', '603', 40, '52000', '-', '-', '-', '-', '-', '-', 64, '-', '054314263', '-', '-', '-', '0846999982', 'yuya101@gmail.com', '20130703', '08:42:36', '20130703', '08:42:36', 1),
(2, '-', '-', 1, '-', '-', '-', '0', 0, 0, '-', '-', '-', '-', '-', '-', 1, '-', '-', '-', '-', '-', '-', '-', 1, '-', '-', '-', '-', '-', '-', 'yuya101@hotmail.com', '20130706', '06:56:54', '20130706', '06:56:54', 1),
(3, 'สวัสดิ์', 'วินิจผล', 1, '-', '-', '-', '-', 0, 0, '1111', '-', '222', '3333', '0', '784', 56, '10120', '-', '-', '-', '-', '-', '-', 1, '-', '314263', '-', '-', '-', '0846999982', 'yuya@gmail.com', '20160525', '00:04:01', '20160525', '00:04:01', 1);
...
CREATE TABLE IF NOT EXISTS `member_login` (
  `memberID` int(8) NOT NULL,
  `member_login` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `member_password` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `member_activate` tinyint(1) NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูล Log In Member';

--
-- Dumping data for table `member_login`
--

INSERT INTO `member_login` (`memberID`, `member_login`, `member_password`, `member_activate`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(1, 'yuya101@gmail.com', 'ball', 1, '20130703', '08:42:36', 1, '20130703', '08:42:36', 1),
(2, 'yuya101@hotmail.com', 'ball', 0, '20130706', '06:56:54', 1, '20130706', '06:56:54', 1),
(3, 'yuya@gmail.com', '1111', 0, '20160525', '00:04:01', 1, '20160525', '00:04:01', 1);

-- --------------------------------------------------------

--
-- Table structure for table `member_picture`
--

CREATE TABLE IF NOT EXISTS `member_picture` (
  `memberID` int(8) NOT NULL,
  `pictureName1` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName2` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName3` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลรูปสมาชิก';

--
-- Dumping data for table `member_picture`
--

INSERT INTO `member_picture` (`memberID`, `pictureName1`, `pictureName2`, `pictureName3`) VALUES
(1, 'memberPicture20130818163701.jpg', '-', '-'),
(2, '-', '-', '-'),
(3, '-', '-', '-');
...
CREATE TABLE IF NOT EXISTS `member_point` (
  `memberID` int(8) NOT NULL,
  `point_1` decimal(7,2) NOT NULL DEFAULT '0.00',
  `point_2` decimal(7,2) NOT NULL DEFAULT '0.00',
  `point_3` decimal(7,2) NOT NULL DEFAULT '0.00',
  `point_4` decimal(7,2) NOT NULL DEFAULT '0.00',
  `point_5` decimal(7,2) NOT NULL DEFAULT '0.00',
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `member_point` (`memberID`, `point_1`, `point_2`, `point_3`, `point_4`, `point_5`, `modDate`, `modTime`, `modID`) VALUES
(1, '310.00', '0.00', '0.00', '0.00', '0.00', '20130703', '08:42:36', 1),
(2, '500.00', '0.00', '0.00', '0.00', '0.00', '20130706', '06:56:54', 1),
(3, '410.00', '0.00', '0.00', '0.00', '0.00', '20160525', '00:04:01', 1);

-- --------------------------------------------------------

--
-- Table structure for table `member_point_history`
--

CREATE TABLE IF NOT EXISTS `member_point_history` (
  `mpid` int(11) NOT NULL,
  `memberID` int(8) NOT NULL,
  `point_1` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT 'แต้มที่ได้เอามาบวก',
  `point_2` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT 'แต้มที่ได้เอามาลบ',
  `point_3` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT 'แต้มที่ได้เอามาคูณ',
  `point_4` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT 'แต้มที่ได้เอามาหาร',
  `point_5` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT '-',
  `getPointTopic` smallint(3) NOT NULL COMMENT 'ได้-เสียคะแนนจากเรื่องอะไร',
  `productID` int(6) NOT NULL,
  `orderID` varchar(14) COLLATE utf8_unicode_ci NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `member_point_history`
--

INSERT INTO `member_point_history` (`mpid`, `memberID`, `point_1`, `point_2`, `point_3`, `point_4`, `point_5`, `getPointTopic`, `productID`, `orderID`, `addDate`, `addTime`, `addID`) VALUES
(1, 1, '500.00', '0.00', '0.00', '0.00', '0.00', 1, 0, '', '20130703', '08:42:36', 1),
(2, 2, '500.00', '0.00', '0.00', '0.00', '0.00', 1, 0, '', '20130706', '06:56:54', 1),
(3, 1, '50.00', '0.00', '0.00', '0.00', '0.00', 2, 1, '', '20130817', '14:38:59', 1),
(4, 1, '0.00', '120.00', '0.00', '0.00', '0.00', 0, 0, 'SP201308200001', '20130820', '16:07:13', 1),
(5, 1, '0.00', '120.00', '0.00', '0.00', '0.00', 0, 0, 'SP201604270002', '20160427', '10:55:05', 1),
(7, 3, '500.00', '0.00', '0.00', '0.00', '0.00', 1, 0, '-', '20160525', '00:04:01', 1),
(8, 3, '0.00', '120.00', '0.00', '0.00', '0.00', 0, 0, 'SP201605300004', '20160530', '15:39:36', 3);
...
CREATE TABLE IF NOT EXISTS `ordering` (
  ...
  `orderID` varchar(14) COLLATE utf8_unicode_ci NOT NULL,
  `memberID` int(8) NOT NULL,
  `orderQuantity` int(3) NOT NULL,
  `orderDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `orderTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `tname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tlastname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tfaddress` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tfvillage` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `tfsoi` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `tfroad` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tftumbon` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `tfamphor` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `tfprovince` int(2) NOT NULL,
  `tfpostcode` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `tftelephone` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `tftelephoneext` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `tfmobile` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `tfemail` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `sendOrderFlag` tinyint(1) NOT NULL COMMENT '0 = Not Send, 1 = Send',
  `trackingNO` varchar(13) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `ordering` (`rid`, `orderID`, `memberID`, `orderQuantity`, `orderDate`, `orderTime`, `tname`, `tlastname`, `tfaddress`, `tfvillage`, `tfsoi`, `tfroad`, `tftumbon`, `tfamphor`, `tfprovince`, `tfpostcode`, `tftelephone`, `tftelephoneext`, `tfmobile`, `tfemail`, `sendOrderFlag`, `trackingNO`) VALUES
(1, 'SP201308200001', 1, 2, '20130820', '16:07:13', 'สวัสดิ์', 'วินิจผล', '3-5-7-7/1', '-', '-', 'วชิราวูธดำเนิน', '5415', '603', 40, '52000', '054314263', '-', '0846999982', '-', 1, 'EB12345678912'),
(2, 'SP201604270002', 1, 2, '20160427', '10:55:05', 'สวัสดิ์', 'วินิจผล', '3-5-7-7/1', '-', '-', 'วชิราวูธดำเนิน', '5415', '603', 40, '52000', '054314263', '-', '0846999982', '-', 0, '-'),
(3, 'SP201605270003', 3, 1, '20160527', '20:54:26', 'สวัสดิ์', 'วินิจผล', '1111', '-', '222', '3333', '0', '784', 56, '10120', '314263', '-', '0846999982', '-', 0, '-'),
(4, 'SP201605300004', 3, 2, '20160530', '15:39:36', 'สวัสดิ์', 'วินิจผล', '1111', '-', '222', '3333', '0', '784', 56, '10120', '314263', '-', '0846999982', '-', 0, '-');
...
CREATE TABLE IF NOT EXISTS `ordering_product` (
  ...
  `productPricePerUnit` decimal(9,2) NOT NULL,
  `orderQuantity` tinyint(3) NOT NULL,
  `adddate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addtime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `moddate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modtime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modUserID` varchar(13) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ordering_product`
--

INSERT INTO `ordering_product` (`rid`, `orderID`, `memberID`, `product_id`, `productPricePerUnit`, `orderQuantity`, `adddate`, `addtime`, `moddate`, `modtime`, `modUserID`) VALUES
(1, 'SP201308200001', 1, 1, '20.00', 1, '20130820', '16:07:13', '20130820', '16:07:13', '1'),
(1, 'SP201308200001', 1, 2, '100.00', 1, '20130820', '16:07:13', '20130820', '16:07:13', '1'),
(2, 'SP201604270002', 1, 1, '20.00', 1, '20160427', '10:55:05', '20160427', '10:55:05', '1'),
(2, 'SP201604270002', 1, 2, '100.00', 1, '20160427', '10:55:05', '20160427', '10:55:05', '1'),
(3, 'SP201605270003', 3, 1, '20.00', 1, '20160527', '20:54:26', '20160527', '20:54:26', '3'),
(4, 'SP201605300004', 3, 1, '20.00', 1, '20160530', '15:39:36', '20160530', '15:39:36', '3'),
(4, 'SP201605300004', 3, 2, '100.00', 1, '20160530', '15:39:36', '20160530', '15:39:36', '3');

-- --------------------------------------------------------

--
-- Table structure for table `order_count_number`
--

CREATE TABLE IF NOT EXISTS `order_count_number` (
  `orderNumber` int(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `order_count_number`
--

INSERT INTO `order_count_number` (`orderNumber`) VALUES
(4);

-- --------------------------------------------------------

--
-- Table structure for table `point_topic`
--

CREATE TABLE IF NOT EXISTS `point_topic` (
  `topicID` smallint(3) NOT NULL,
  `topicDeail` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `topicPoint` decimal(7,2) NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลหัวข้อที่ให้ Point';

--
-- Dumping data for table `point_topic`
--

INSERT INTO `point_topic` (`topicID`, `topicDeail`, `topicPoint`, `addDate`, `addTime`, `modDate`, `modTime`, `modID`) VALUES
(1, 'สมัครสมาชิก', '500.00', '20130710', '10:00:00', '20130710', '10:00:00', 1),
(2, 'แสดงความคิดเห็น', '50.00', '20130802', '10:00:00', '20130802', '10:00:00', 1);
...
CREATE TABLE IF NOT EXISTS `product_brand` (
  `brandID` smallint(3) NOT NULL,
  `brandName` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `brandAddress1` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `brandAddress2` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `brandTel` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `brandFax` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `brandWebsite` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `brandPicture` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลยี่ห้อสินค้า';

--
-- Dumping data for table `product_brand`
--

INSERT INTO `product_brand` (`brandID`, `brandName`, `brandAddress1`, `brandAddress2`, `brandTel`, `brandFax`, `brandWebsite`, `brandPicture`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(2, 'Triump', 'ทดสอบยี่ห้อ2_1', 'ทดสอบยี่ห้อ2_2', 'ทดสอบยี่ห้อ2_3', 'ทดสอบยี่ห้อ2_4', 'http://www.supercheap.co.th', 'brandPicture20130812150412.jpg', '20130812', '15:04:12', 1, '20130812', '15:04:12', 1),
(1, 'BSC12', 'ทดสอบยี่ห้อ1_1', 'ทดสอบยี่ห้อ1_21', 'ทดสอบยี่ห้อ1_31', 'ทดสอบยี่ห้อ1_4', 'http://www.pnsport.com', 'brandPicture20130812150256.jpg', '20130812', '15:02:56', 1, '20160529', '17:34:27', 3),
(3, 'The Sample', '3-5-7 Watchirawutdumnoun Rd. Muang', '-', '-', '-', '-', '-', '20160528', '20:20:23', 3, '20160528', '20:20:23', 3);
...
CREATE TABLE IF NOT EXISTS `product_category` (
  ...
  `catDetail` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `catPicture` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูล Category';

--
-- Dumping data for table `product_category`
--

INSERT INTO `product_category` (`catID`, `typeID`, `catName`, `catDetail`, `catPicture`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(3, 1, 'Face Facial', 'ทดสอบกลุ่มหลัก3', 'catPicture20130812151105.jpg', '20130812', '15:11:05', 1, '20130812', '15:11:05', 1),
(2, 2, 'Hand Care', 'ทดสอบกลุ่มหลัก2', 'catPicture20130812150938.jpg', '20130812', '15:09:38', 1, '20130812', '15:09:38', 1),
(1, 2, 'Body Care', 'ทดสอบกลุ่มหลัก1', 'catPicture20130812150902.jpg', '20130812', '15:09:02', 1, '20130812', '15:09:02', 1),
(5, 2, '313211', '11111', '-', '20160529', '19:02:28', 3, '20160529', '19:41:02', 3),
(6, 1, '32132', '1131', '-', '20160529', '19:03:03', 3, '20160529', '19:03:03', 3);

-- --------------------------------------------------------

--
-- Table structure for table `product_cat_description`
--

CREATE TABLE IF NOT EXISTS `product_cat_description` (
  ...
  `description3` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description4` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description5` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description6` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description7` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description8` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description9` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description10` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description11` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description12` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description13` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description14` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description15` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description16` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description17` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description18` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description19` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description20` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลรายละเอียด Product';

--
-- Dumping data for table `product_cat_description`
--

INSERT INTO `product_cat_description` (`productID`, `description1`, `description2`, `description3`, `description4`, `description5`, `description6`, `description7`, `description8`, `description9`, `description10`, `description11`, `description12`, `description13`, `description14`, `description15`, `description16`, `description17`, `description18`, `description19`, `description20`) VALUES
(1, 'ทดสอบ1', 'ทดสอบ2', 'ทดสอบ3', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(2, 'ทดสอบ2', 'ทดสอบ2', 'ทดสอบ2', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(3, '132121', '321321', '321321', '31321', '32113131', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(4, '32132', '1313', '313', '1321123', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(5, '1321', '3231', '31313', '1321123', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(6, '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-');

-- --------------------------------------------------------

--
-- Table structure for table `product_cat_header`
--

CREATE TABLE IF NOT EXISTS `product_cat_header` (
  `catID` smallint(3) NOT NULL,
  `header1` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header2` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header3` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header4` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header5` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header6` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header7` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header8` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header9` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header10` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header11` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header12` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header13` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header14` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header15` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header16` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header17` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header18` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header19` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `header20` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลลักษณะสินค้า';

--
-- Dumping data for table `product_cat_header`
--

INSERT INTO `product_cat_header` (`catID`, `header1`, `header2`, `header3`, `header4`, `header5`, `header6`, `header7`, `header8`, `header9`, `header10`, `header11`, `header12`, `header13`, `header14`, `header15`, `header16`, `header17`, `header18`, `header19`, `header20`) VALUES
(1, '1', '2', '3', '4', '5', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(2, '1111', '2222', '3333', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(3, '777', '888', '999', '123456', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(5, '31321', '3', '1321', '321', '321', '321', '313131', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(6, '32132132', '1321', '31', '332', '13', '13', '1321', '1', '13', '1313', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-');
...
CREATE TABLE IF NOT EXISTS `product_main` (
  ...
  `typeID` smallint(3) NOT NULL,
  `catID` smallint(3) NOT NULL,
  `subcatID` smallint(3) NOT NULL,
  `productName` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `productDetail` text COLLATE utf8_unicode_ci NOT NULL,
  `productPrice` decimal(7,2) NOT NULL,
  `productDiscount` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `productQuantity` int(5) NOT NULL,
  `productClickCount` int(6) NOT NULL,
  `productStatus` tinyint(1) NOT NULL COMMENT '1 = Enable, 0 = Disable',
  `productType` tinyint(1) NOT NULL,
  `productStartDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `productModDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `productDelDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `productCode` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `productShowPrice` tinyint(1) NOT NULL,
  `productApprove` tinyint(1) NOT NULL,
  `productArrang` int(5) NOT NULL,
  `productApproveComment` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `productIncludeInstall` tinyint(1) NOT NULL,
  `productState` tinyint(1) NOT NULL,
  `productDownPayment` decimal(6,2) NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูล Product';

--
-- Dumping data for table `product_main`
--

INSERT INTO `product_main` (`productID`, `brandID`, `typeID`, `catID`, `subcatID`, `productName`, `productDetail`, `productPrice`, `productDiscount`, `productQuantity`, `productClickCount`, `productStatus`, `productType`, `productStartDate`, `productModDate`, `productDelDate`, `productCode`, `productShowPrice`, `productApprove`, `productArrang`, `productApproveComment`, `productIncludeInstall`, `productState`, `productDownPayment`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(1, 1, 2, 1, 1, 'Nivia Cream ทาตัว', 'ครืมทาตัวของยี่ห้อ Nivia', '20.00', '0', 10, 238, 1, 0, '20130813', '-', '-', 'NV12-0121', 1, 1, 0, '-', 0, 0, '0.00', '20130813', '16:32:13', 1, '20130813', '16:32:13', 1),
(2, 2, 1, 3, 2, 'Nivia Cream ทาหน้า', 'Nivia Cream ทาหน้า', '100.00', '10', 6, 11, 1, 0, '20130813', '-', '-', 'NV25-0557', 1, 1, 0, '-', 0, 0, '0.00', '20130813', '16:58:03', 1, '20130813', '16:58:03', 1),
(3, 3, 2, 1, 1, '7777777', '999999', '20555.00', '100', 100, 0, 1, 0, '5-306-20', '-', '-', '888888', 1, 1, 0, '-', 0, 0, '0.00', '20160530', '20:14:18', 3, '20160530', '20:14:18', 3),
(4, 1, 2, 1, 1, '999997989897', '97797', '97987.00', '9999', 987, 20, 1, 0, '20150717', '-', '-', '987987987', 1, 1, 1, '-', 0, 1, '0.00', '20160530', '20:41:09', 3, '20160530', '20:41:09', 3),
(5, 1, 1, 3, 2, '9999979898978888', '97797', '97987.00', '9999', 987, 0, 1, 0, '20150717', '-', '-', '987987987', 1, 1, 1, '-', 0, 1, '0.00', '20160530', '20:43:11', 3, '20160530', '20:43:11', 3),
(6, 1, 2, 1, 1, '999997989897888897987', '97797', '97987.00', '9999', 987, 0, 1, 0, '20150717', '-', '-', '987987987', 1, 1, 1, '-', 0, 1, '0.00', '20160530', '20:43:59', 3, '20160530', '20:43:59', 3);
...
CREATE TABLE IF NOT EXISTS `product_picture` (
  `productID` int(6) NOT NULL,
  `pictureName1` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName2` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName3` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName4` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName5` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName6` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName7` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName8` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName9` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `pictureName10` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลรูป Product';

--
-- Dumping data for table `product_picture`
--

INSERT INTO `product_picture` (`productID`, `pictureName1`, `pictureName2`, `pictureName3`, `pictureName4`, `pictureName5`, `pictureName6`, `pictureName7`, `pictureName8`, `pictureName9`, `pictureName10`) VALUES
(1, 'productPicture020130813163213.jpg', 'productPicture120130813163214.jpg', 'productPicture220130813163214.jpg', '-', '-', '-', '-', '-', '-', '-'),
(2, 'productPicture020130813165804.jpg', 'productPicture120130813165804.jpg', 'productPicture220130813165804.jpg', '-', '-', '-', '-', '-', '-', '-'),
(3, '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'),
(6, 'productPicture020160530204359.jpg', '-', '-', '-', '-', '-', '-', '-', '-', '-');
...
CREATE TABLE IF NOT EXISTS `product_rating` (
  `proRatingID` int(6) NOT NULL,
  `productID` int(6) NOT NULL,
  `reviewID` int(6) NOT NULL,
  `ratingTopicID` smallint(3) NOT NULL,
  `proRatingPoint` tinyint(1) NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลการให้คะแนน';

--
-- Dumping data for table `product_rating`
--

INSERT INTO `product_rating` (`proRatingID`, `productID`, `reviewID`, `ratingTopicID`, `proRatingPoint`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(1, 1, 1, 1, 5, '20130816', '22:50:02', 1, '20130816', '22:50:02', 1),
(2, 1, 1, 2, 4, '20130816', '22:50:02', 1, '20130816', '22:50:02', 1),
(3, 1, 1, 3, 3, '20130816', '22:50:02', 1, '20130816', '22:50:02', 1),
(4, 1, 1, 4, 2, '20130816', '22:50:02', 1, '20130816', '22:50:02', 1),
(5, 1, 1, 5, 1, '20130816', '22:50:02', 1, '20130816', '22:50:02', 1),
(6, 2, 2, 1, 1, '20130817', '14:38:59', 1, '20130817', '14:38:59', 1),
(7, 2, 2, 2, 4, '20130817', '14:38:59', 1, '20130817', '14:38:59', 1),
(8, 2, 2, 3, 2, '20130817', '14:38:59', 1, '20130817', '14:38:59', 1),
(9, 2, 2, 4, 3, '20130817', '14:38:59', 1, '20130817', '14:38:59', 1),
(10, 2, 2, 5, 5, '20130817', '14:38:59', 1, '20130817', '14:38:59', 1),
(11, 1, 3, 1, 3, '20160528', '16:20:54', 3, '20160528', '16:20:54', 3),
(12, 1, 3, 2, 3, '20160528', '16:20:54', 3, '20160528', '16:20:54', 3),
(13, 1, 3, 3, 3, '20160528', '16:20:54', 3, '20160528', '16:20:54', 3),
(14, 1, 3, 4, 3, '20160528', '16:20:54', 3, '20160528', '16:20:54', 3),
(15, 1, 3, 5, 3, '20160528', '16:20:54', 3, '20160528', '16:20:54', 3);
...
CREATE TABLE IF NOT EXISTS `product_reviews` (
  ...
  `memberID` int(8) NOT NULL,
  `productID` int(6) NOT NULL,
  `reviewTopic` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `reviewDetail` text COLLATE utf8_unicode_ci NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลการ Review สินค้า';

--
-- Dumping data for table `product_reviews`
--

INSERT INTO `product_reviews` (`reviewID`, `memberID`, `productID`, `reviewTopic`, `reviewDetail`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(1, 1, 1, '-', 'ทดสอบการแสดงความคิดเห็น', '20130816', '22:50:02', 1, '20130816', '22:50:02', 1),
(2, 1, 2, '-', 'สินค้าตัวนี้ดีมากๆเลยค่ะ', '20130817', '14:38:59', 1, '20130817', '14:38:59', 1),
(3, 3, 1, '-', '131321', '20160528', '16:20:54', 3, '20160528', '16:20:54', 3);
...
CREATE TABLE IF NOT EXISTS `product_subcategory` (
  `subcatID` smallint(3) NOT NULL,
  `catID` smallint(3) NOT NULL,
  `subcatName` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `subcatDetail` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `subcatPicture` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูล Sub Category';

--
-- Dumping data for table `product_subcategory`
--

INSERT INTO `product_subcategory` (`subcatID`, `catID`, `subcatName`, `subcatDetail`, `subcatPicture`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(2, 3, 'Facial Form', 'subcatPictureThumb', 'subCatPicture20130812153736.jpg', '20130812', '15:37:36', 1, '20130812', '15:37:36', 1),
(1, 1, 'Cream', 'ทดสอบกลุ่มย่อย1', 'subCatPicture20130812153552.jpg', '20130812', '15:35:52', 1, '20130812', '15:35:52', 1),
(3, 3, '77771111', '111112', '-', '20160529', '20:01:40', 3, '20160529', '20:22:01', 3);
...
CREATE TABLE IF NOT EXISTS `product_types` (
  ...
  `typeDetail` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `typePicture` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูลหัวข้อหลัก';

--
-- Dumping data for table `product_types`
--

INSERT INTO `product_types` (`typeID`, `typeName`, `typeDetail`, `typePicture`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(2, 'Body', 'ทดสอบประเภท2', 'typePicture20130812150646.jpg', '20130812', '15:06:46', 1, '20130812', '15:06:46', 1),
(1, 'Face', 'ทดสอบประเภท1', 'typePicture20130812150631.jpg', '20130812', '15:06:31', 1, '20130812', '15:06:31', 1),
(3, '1234', '123', '-', '20160529', '17:50:26', 3, '20160529', '18:27:44', 3);
...
--
-- Table structure for table `rating_topic`
--

CREATE TABLE IF NOT EXISTS `rating_topic` (
  `ratingTopicID` smallint(3) NOT NULL,
  `ratingName` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `ratingDetail` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `addDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addID` smallint(3) NOT NULL,
  `modDate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modTime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modID` smallint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตารางเก็บข้อมูล Rating เช่น กลิ่น ขนาด จำนวน';

--
-- Dumping data for table `rating_topic`
--

INSERT INTO `rating_topic` (`ratingTopicID`, `ratingName`, `ratingDetail`, `addDate`, `addTime`, `addID`, `modDate`, `modTime`, `modID`) VALUES
(1, 'Feeling', 'Feeling', '20130802', '10:00:00', 1, '20130802', '10:00:00', 1),
(2, 'Overall Experi', 'Overall Experience', '20130802', '10:00:00', 1, '20130802', '10:00:00', 1),
(3, 'Texture', 'Texture', '20130802', '10:00:00', 1, '20130802', '10:00:00', 1),
(4, 'Effectiveness', 'Effectiveness', '20130802', '10:00:00', 1, '20130802', '10:00:00', 1),
(5, 'Scent', 'Scent', '20130802', '10:00:00', 1, '20130802', '10:00:00', 1);
...
CREATE TABLE IF NOT EXISTS `user_group` (
  ...
  `group_detail` text COLLATE utf8_unicode_ci NOT NULL,
  `adddate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `addtime` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `moddate` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `modtime` varchar(8) COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `user_group` (`gid`, `group_name`, `group_detail`, `adddate`, `addtime`, `moddate`, `modtime`) VALUES
(1, 'ผู้ดูแลระบบ', 'ADMINISTRATOR', '20150909', '10:00:00', '20150909', '10:00:00'),
(2, 'บัญชี', 'Account', '20150909', '10:00:00', '20150909', '10:00:00'),
(3, 'การเงิน', 'Finance', '20150909', '10:00:00', '20150909', '10:00:00');
...
--
-- Indexes for table `blog_answer`
--
ALTER TABLE `blog_answer`
...
--
-- Indexes for table `member_picture`
--
ALTER TABLE `member_picture`
  ADD PRIMARY KEY (`memberID`);
...
--
-- Indexes for table `member_point_history`
--
...
--
-- Indexes for table `point_topic`
--
ALTER TABLE `point_topic`
...
--
-- Indexes for table `product_cat_description`
--
ALTER TABLE `product_cat_description`
  ADD PRIMARY KEY (`productID`);

--
-- Indexes for table `product_cat_header`
--
ALTER TABLE `product_cat_header`
  ADD PRIMARY KEY (`catID`);
...
--
-- Indexes for table `rating_topic`
--
ALTER TABLE `rating_topic`
  ADD PRIMARY KEY (`ratingTopicID`);
...
--
-- AUTO_INCREMENT for table `member_point_history`
--
ALTER TABLE `member_point_history`
  MODIFY `mpid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
